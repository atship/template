...
static LRESULT CALLBACK WndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_KEYDOWN:
        ...
        break;
	case WM_LBUTTONDOWN:
		OnNativeWinMouseDown(GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam), true);
		break;

	case WM_LBUTTONUP:
		OnNativeWinMouseUp(GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam), true);
		break;
...
bool CreateNativeWin(int width, int height, EGLNativeWindowType* nativewin_out)
{
    bool result = true;
